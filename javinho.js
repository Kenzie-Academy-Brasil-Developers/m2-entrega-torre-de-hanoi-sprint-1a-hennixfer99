...
dif1_button.addEventListener("click", (event) => {
    if (event.currentTarget.lastElementChild !== null) {
        teste = false;
        movimento = null;
    }
...
dif2_button.addEventListener("click", (event) => {
    if (event.currentTarget.lastElementChild !== null) {
        teste = false;
        movimento = null;
    }
...
dif3_button.addEventListener("click", (event) => {
    if (event.currentTarget.lastElementChild !== null) {
        teste = false;
        movimento = null;
    }
...
function vitoria() {
    if (torre3.childElementCount === dif) {
        counter.innerText = `${contagem} movimentos`;
